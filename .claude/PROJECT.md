...
- Estado global de cliente: React Context, restrito ao pequeno conjunto de coisas realmente globais como sessão/auth, tema (dark/light), ordenação das tabs dos feeds, entre outros.
